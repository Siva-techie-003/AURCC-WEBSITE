                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {links.map((link, i) => (
                        ...
                        >
                            ...
                            <span className="text-sm lg:text-base font-bold text-gray-700 group-hover:text-[rgb(100,25,25)] leading-snug">
                                {link.label}
                            </span>

                            <svg
                                className="ml-auto w-5 h-5 text-gray-300 group-hover:text-[rgb(120,45,45)] transform group-hover:translate-x-1 transition-all"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
        ...
        <main className="bg-white min-h-screen font-sans text-gray-800 text-left">
            ...
            <section className="relative w-full h-48 sm:h-60 md:h-80 lg:h-[45vh] overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white drop-shadow-lg tracking-tight text-center mb-4 animate-scale-in">
                        Downloads
                    </h1>
                    <p className="text-base sm:text-lg lg:text-xl text-white drop-shadow text-center font-medium opacity-90 max-w-2xl">
