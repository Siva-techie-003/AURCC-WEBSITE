...
{Array.isArray(department) && department.map((alumnus, index) => (                                    <div
                                        ...
                                        className="bg-white rounded-xl shadow-sm 
                                                ...
                                                border-l-4 border-l-[rgb(120,45,45)] 
                                                text-left
                                                w-[320px]">

                                        <div className="font-bold text-base lg:text-lg text-[rgb(110,35,35)]">
                                        {alumnus.Name}
                                        </div>
                                        ...
                                        <div className="text-sm lg:text-base text-gray-600 italic">
                                        {alumnus.Company}
                                        </div>
