...
const HomeView = () => {
    ...
    useEffect(() => {
        if (location.state?.scrollTo) {
            if (location.state.scrollTo === 'home_page') {
            ...
            <div className="pt-20 sm:pt-24 lg:pt-32">
                ...
                <main className="">
                    ...
                    <section id='home_page' className="relative h-[300px] md:h-[400px] lg:h-[700px] flex items-center justify-center overflow-hidden ">
                        ...
                        >
                            <span
                                className="text-white text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full"
                                style={{
                            ...
                            <div className="flex flex-col items-center animate-bounce">
                                ...
                                <svg
                                    ...
                                    style={{ color: '#d4a017', opacity: 0.5 }}
                                    fill="none"
                                    stroke="currentColor"
                                    strokeWidth="2.5"
                                    viewBox="0 0 24 24"
                    ...
                    <section id="stats" ref={statsRef} className="container mx-auto px-4 sm:px-6 lg:px-8 relative mt-16 sm:mt-20 md:mt-24 lg:mt-12 z-30 mb-12 sm:mb-16 lg:mb-20">
                            ...
                            <div className="w-full">
                                <div className="mobile-grid relative">
                                    ...
                                    <div className="rounded-lg bg-white/80 backdrop-blur-sm shadow-lg overflow-hidden border border-[rgb(180,100,100)]">
                                            ...
                                            >
                                                {[...news, ...news].map((item, idx) => (
                                                    <li key={idx} className="flex font-bold items-center py-3 px-6 hover:bg-[rgb(220,140,140)] transition-colors duration-200 group cursor-pointer">
                                                        <div className="mr-3 flex-shrink-0 w-2 h-2 bg-[rgb(180,80,80)] rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                                        ...
                                        {/* View All — pinned, never scrolls */}
                                        <div className="border-t border-gray-200 px-6 py-3">
                                            <Link to="/news" className="flex items-center text-[rgb(115,40,40)] font-medium group hover:text-[rgb(80,20,20)] transition-colors">
                                    ...
                                    <div className="rounded-lg bg-white/80 backdrop-blur-sm shadow-lg overflow-hidden border border-[rgb(180,100,100)]">
                                        ...
                                        {/* View All — pinned, never scrolls */}
                                        <div className="border-t border-gray-200 px-6 py-3">
                                            <Link to="/events" className="flex items-center text-[rgb(115,40,40)] font-medium group hover:text-[rgb(80,20,20)] transition-colors">
                                                View All Events
                                                <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"></path></svg>
                                            </Link>
                                        </div>
  ...
  `}
                    ...
                    <div className="fixed bottom-6 right-6 z-50">
                        <button
                            ...
                            style={{
                                background: 'linear-gradient(135deg, rgb(140,50,50) 0%, rgb(100,20,20) 100%)',
                                boxShadow: '0 8px 32px rgba(115,25,25,0.55)',
                            }}
                            aria-label="Open Help Desk"
                        >
                            <span className="absolute inset-0 rounded-full animate-ping" style={{ background: 'rgba(115,25,25,0.35)' }} />
                            <span className="absolute inset-0 rounded-full" style={{ border: '2px solid rgba(245,200,66,0.45)' }} />
                    ...
                    {/* Modern Chat Dialog */}
                    <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle bg-transparent backdrop-blur-sm">
                        <div
                            className="fixed bottom-24 right-6 w-[340px] rounded-2xl overflow-hidden shadow-2xl"
                            style={{ background: '#1a1a2e', border: '1px solid rgba(255,255,255,0.08)' }}
                        >
                            {/* Header */}
                            <div
                                className="flex items-center justify-between px-5 py-4"
                                style={{ background: 'linear-gradient(135deg, rgb(120,35,35) 0%, rgb(80,15,15) 100%)' }}
                            >
                                <div className="flex items-center gap-3">
                                    <div className="relative">
                                        ...
                                        <span className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-green-400 border-2 border-[rgb(80,15,15)]" />
                                    </div>
                                    <div>
                                        <p className="text-white font-bold text-sm leading-tight">AURCC Support</p>
                                        <p className="text-green-400 text-xs font-medium">Online</p>
                                    </div>
                                </div>
                                <form method="dialog">
                                    <button className="w-8 h-8 rounded-full flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all text-lg leading-none">
                                        ✕
                                    </button>
                                </form>
                            </div>
                            ...
                            {/* Messages area */}
                            <div
                                className="flex flex-col gap-3 px-4 py-4 h-64 overflow-y-auto"
                                ref={chatContainerRef}
                                style={{ background: '#12121f', scrollbarWidth: 'none' }}
                            >
                                {chatLog.length === 0 && (
                                    <div className="flex justify-start">
                                        <div
                                            className="text-sm px-4 py-2.5 rounded-2xl rounded-tl-sm max-w-[80%]"
                                    ...
                                    <div key={idx} className={`flex ${chat.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                        <div
                                            ...
                                            style={chat.sender === 'user'
                                                ? { background: 'linear-gradient(135deg, rgb(160,60,60), rgb(110,25,25))', color: '#fff', borderBottomRightRadius: '4px' }
                                ...
                                {loading && (
                                    <div className="flex justify-start">
                                        <div className="px-4 py-2.5 rounded-2xl rounded-tl-sm" style={{ background: 'rgba(255,255,255,0.07)' }}>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    style={{ background: 'linear-gradient(135deg, rgb(140,50,50), rgb(100,20,20))' }}
                                >
