        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-150 p-6 sm:p-8 flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                All data, images, and content on this website are reserved. The design, development, and technical maintenance of this website belong to the developers of the site.
              </p>
            </div>
          </div>
        </div>
