        ...
        >
          ...
          <div className="p-8 space-y-4">
            {(Array.isArray(content?.description)
              ...
              <p
                key={index}
                className="text-base lg:text-lg text-gray-700 leading-relaxed font-medium"
              >
                {item}
              </p>
            ))}
          ...
          <div className="p-8">
            <div className="bg-[rgb(220,140,140)]/50 rounded-2xl p-6 border border-[rgb(200,120,120)] text-[rgb(100,25,25)] font-bold text-base lg:text-lg leading-relaxed  whitespace-pre-line">
              {content?.["Re-Admission"] ||
                "Re-admission information will be updated soon."}
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="p-8">
            <div className="mb-6 p-4 bg-[rgb(220,140,140)]/50 rounded-xl border-l-4 border-[rgb(115,40,40)]">
              <p className="text-lg lg:text-xl font-bold text-[rgb(100,25,25)]">
                {content?.Scholarship?.description ||
                  "Scholarship information will be updated soon."}
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {(Array.isArray(content?.Scholarship?.["list of scholarships"])
                ? content.Scholarship["list of scholarships"]
                : []
              ).map((scholarship, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-4 bg-white border border-gray-200 rounded-xl hover:border-[rgb(160,80,80)] transition-colors"
                >
                  <span
        ...
        >
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {(Array.isArray(
                content?.["Office bearers"]?.["Administration staff"],
              )
                ? content["Office bearers"]["Administration staff"]
                : []
              ).map((staff, index) => (
                ...
                >
                  ...
                  <h3 className="font-bold text-lg text-[rgb(100,25,25)] uppercase tracking-tight">
