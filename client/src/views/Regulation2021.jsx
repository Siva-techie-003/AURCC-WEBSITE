    ...
    fetch("/api/regulations")
      ...
      .then(data => {
        const filtered = (data.regulations || []).filter(reg => 
            reg['Regulation'] && reg['Regulation'].includes('2021')
        );
            ...
            <div className="flex-grow bg-gradient-to-br from-gray-100 via-[rgb(255, 255, 255)] to-white min-h-screen text-left">
                ...
                <section className="relative w-full h-48 sm:h-60 md:h-80 lg:h-[40vh] overflow-hidden flex items-center justify-center">
                    ...
                    <div className="relative z-10 text-center animate-fadeIn px-4">
                        <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black text-white uppercase tracking-tighter mb-4">Regulation 2021</h1>
                    ...
                    <section className="animate-fadeInUp">
                        <header className="flex flex-col md:flex-row md:items-end justify-between border-b-4 border-[rgb(100,25,25)] pb-8 mb-12 gap-6">
                            <div className="max-w-xl">
                                <h2 className="text-2xl lg:text-4xl font-black text-[rgb(90,20,20)] uppercase tracking-tight">Academic Integrity (2021)</h2>
                                <p className="text-lg text-gray-500 font-bold mt-2 italic">Essential guidelines for students under Anna University Regulations 2021.</p>
                            </div>
                        </header>
                        ...
                        {regulations.length === 0 && (
                            <p className="text-center text-gray-500 py-10">No regulations found for the year 2021.</p>
                        )}
                    </section>
