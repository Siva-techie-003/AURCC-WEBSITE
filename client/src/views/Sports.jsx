...
const Sports = () => {
  ...
  return (
    <main className="flex-grow font-sans bg-gray-50 text-left pt-[120px] sm:pt-[140px] lg:pt-[120px]">
      {/* Hero section */}
      <section className="relative w-full h-40 sm:h-56 md:h-40 lg:h-[40vh] overflow-hidden flex flex-col justify-end ">
        <img
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4 ">
          <div className="backdrop-blur-md bg-brown/30 rounded-2xl shadow-lg px-6 py-6 md:py-10 flex flex-col items-center max-w-2xl mx-auto border border-white/30 animate-popIn">
            <h1 className="text-2xl lg:text-3xl xl:text-4xl font-extrabold text-white drop-shadow-lg tracking-tight text-center mb-2">
              {data.name}
            </h1>
            <p className="text-sm lg:text-lg text-white drop-shadow text-center font-medium opacity-90">
              Promoting Sportsmanship and Fitness
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto py-12 px-4 space-y-12">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 -mt-8 overflow-hidden hover:shadow-lg transition-all animate-fadeIn">
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-[rgb(220,140,140)]/50 rounded-2xl p-6 border border-[rgb(200,120,120)] flex flex-col items-start transition-all ">
                ...
                <ul className="space-y-4 w-full">
                  {(Array.isArray(data?.facilities?.IndoorGames)
                    ? data.facilities.IndoorGames
                    : []
                  ).map((game, i) => (
                    <li
                      key={i}
                      className="flex gap-4 items-center animate-fadeInUp"
                    >
              ...
              <div className="bg-[rgb(220,140,140)]/50 rounded-2xl p-6 border border-[rgb(200,120,120)] flex flex-col items-start transition-all ">
                ...
                <ul className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {(Array.isArray(data?.facilities?.OutdoorGames)
                    ? data.facilities.OutdoorGames
                    : []
                  ).map((game, i) => (
                    <li
                      key={i}
